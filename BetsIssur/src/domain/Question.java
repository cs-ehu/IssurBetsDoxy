...
public class Question implements Serializable {
	...
	public Question(Integer queryNumber, String query, float betMinimum,
			Event event) {
		super();
	...
	public Forecast addForecast(String question, float betMinimum) {
		Forecast f = new Forecast(question, betMinimum, this);
		forecasts.add(f);
		return f;
	}
	...
	public String toString() {
		return questionNumber + "-" + question + " Min="
				+ Float.toString(betMinimum);
	}
